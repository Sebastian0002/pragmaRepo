...
class CatInfoRepository implements CatInfoInterface {
  ...
  @override
  Future<Map<String, dynamic>> getCatImages(
      {required List<String> idsList}) async {
    final dio = Dio();
    Map<String, dynamic> map = {};
    String idsToSearch = idsList
        .toString()
        .replaceAll("[", "")
        .replaceAll("]", "")
        .replaceAll(" ", "");
    ...
    try {
      ...
      final response = await dio.get(
          "$api/images/search?limit=100&breed_ids=$idsToSearch&api_key=$token");
